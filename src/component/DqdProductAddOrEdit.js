...
class DqdProductAddOrEdit extends Component {
  constructor(props) {
    super(props);
    this.state = {
      id: 1,
    ...
    return (
      <div>
        ...
        <form className="col-md-6">
          ...
          <button className="btn btn-success" onClick={this.DqdHandleSubmit}>Thêm</button>
        </form>
      </div>
    );
  }
...
export default DqdProductAddOrEdit;
